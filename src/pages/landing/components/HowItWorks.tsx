  ...
  return (
    <section className="py-16 bg-white">
      <div className="container mx-auto px-6">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">Seamless Digital Waybill Management</h2>
            ...
            <div className="mb-12">
              <div className="flex items-start mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Traders generate electronic waybills via web or mobile app, capturing all essential shipment details in minutes.</p>
                </div>
              </div>
              ...
              <div className="flex items-start mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Instant authentication at checkpoints using secure QR technology, eliminating fraud and ensuring compliance.</p>
                </div>
              </div>
              ...
              <div className="flex items-start mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Government officials track trade flows and revenue in real-time through comprehensive dashboards.</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Comprehensive analytics for policy and infrastructure planning based on actual trade patterns.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gray-50 p-8 rounded-lg">
          <h3 className="text-xl font-bold mb-4 text-center">Traditional Paper Process vs. Digital eWaybill Process</h3>
