        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600">
                Create digital waybills with comprehensive details including driver, vehicle,
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600">
                Access complete records of all waybills and payments with detailed filtering and
                search capabilities.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600">
                Document and resolve issues with a structured system for tracking incidents and
                their resolution.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600">
                Maintain a detailed audit trail of all system actions for accountability and
                transparency.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600">
                Manage agent commissions and payments with automated calculations and transparent
                reporting.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600">
                Gain comprehensive insights through data visualization and reporting for informed
                decision-making.
              </p>
            </div>
          </div>
