        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-gray-600 mb-6">
              Our eWaybill Management System comes with purpose-built POS devices that enable
              instant verification and receipt printing in the field. These rugged devices ensure
              your operations continue smoothly even in remote areas with limited connectivity.
            </p>
            ...
            <p className="text-gray-600">
              The integrated POS solution ensures that your field officers can verify waybills,
              collect payments, and issue receipts on the spot, enhancing efficiency and reducing
              opportunities for fraud or revenue leakage.
            </p>
          </div>
